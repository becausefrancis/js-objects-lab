...
game.difficulty = ['Easy', 'Moderate', 'Hard', 'Extreme'];
...
game.party.push(pokemon[37], pokemon[149], pokemon[150]);
...
and three gym objects have a value of `false` on their `completed` property, the logged value would be: `{ completed: 5, incomplete: 3 }`.

Solve Exercise 13 here:
*/

game.gymStatus = function () {
    game.gymTally = {completed: 0, incomplete: 0};
    for (let g of game.gyms) {
        if (g.completed) {
